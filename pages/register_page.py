...
class RegPage(WebPage):
    ...
    registration_button = WebElement(xpath='//*[@id="page-right"]/div/div/div/form/button') #or name="register"
    ...
    #registration_button = WebElement(xpath='//*[@id="page-right"]/div/div/div/form/div[1]/div/div/div[2]/button[2]')
